...
// RegisterUserRoutes adds user-related endpoints to the router group using the provided StorageManager.
func RegisterUserRoutes(rg *gin.RouterGroup, manager *storage.StorageManager, sm *SessionManager) {
